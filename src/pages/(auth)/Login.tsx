          ...
          {requires2fa ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="border-gray-tertiary/32 focus:border-primary-main focus:ring-primary-main/20 h-12 w-full rounded-full border pr-4 pl-11 text-sm transition-shadow focus:ring-4 focus:outline-0 bg-white text-gray-primary"
                  />
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="border-gray-tertiary/32 focus:border-primary-main focus:ring-primary-main/20 h-12 w-full rounded-full border pr-11 pl-11 text-sm transition-shadow focus:ring-4 focus:outline-0 bg-white text-gray-primary"
                  />
                  <button
                    type="button"
                ...
                <div className="flex items-center justify-between text-sm">
                  <label className="text-gray-secondary flex items-center gap-2 cursor-pointer select-none">
                    <input type="checkbox" className="accent-primary-main size-4 cursor-pointer" />
                    Remember me
                  </label>
                  <Link to="/password-lost" className="text-primary-main font-medium hover:underline">
                    Forgot password?
                  </Link>
                </div>
              ...
              <p className="text-gray-secondary mt-8 text-center text-sm">
                ...
                <Link to="/signup" className="text-primary-main font-medium hover:underline">
                  Create one
                </Link>
              </p>
            </>
